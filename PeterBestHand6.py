...
def high_cards(pip1, pip2, pip3, pip4, pip5, pip6):
    ...
    in_order = sorted([new_pip1, new_pip2, new_pip3, new_pip4, new_pip5, new_pip6], reverse=True)
    high_card = in_order[0]
    return high_card


def second_high_cards(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def third_high_cards(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def fourth_high_cards(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def fifth_high_cards(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def sixth_high_cards(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def seventh_high_cards(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def pairs(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def two_pairs(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
    ...
    two_pair = 0
    two_pair_kicker = 0
    sorted_pips = sorted([new_pip1, new_pip2, new_pip3, new_pip4, new_pip5, new_pip6], reverse=True)
    if sorted_pips[0] == sorted_pips[1]:
        two_pair = sorted_pips[0]
        if sorted_pips[2] == sorted_pips[3 or 4 or 5]:
            two_pair_kicker = sorted_pips[2]
        elif sorted_pips[3] == sorted_pips[4 or 5]:
            two_pair_kicker = sorted_pips[3]
        elif sorted_pips[4] == sorted_pips[5]:
            two_pair_kicker = sorted_pips[4]
    elif sorted_pips[1] == sorted_pips[2]:
        two_pair = sorted_pips[1]
        if sorted_pips[3] == sorted_pips[4 or 5]:
            two_pair_kicker = sorted_pips[3]
        elif sorted_pips[4] == sorted_pips[5]:
            two_pair_kicker = sorted_pips[4]
    elif sorted_pips[2] == sorted_pips[3]:
        two_pair = sorted_pips[2]
        if sorted_pips[4] == sorted_pips[5]:
            two_pair_kicker = sorted_pips[4]
...
def two_pair_kickers(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def trips(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def straights(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def flushes(suit1, suit2, suit3, suit4, suit5, suit6):
    flush = 0
    heart_count = 0
    diamond_count = 0
    spade_count = 0
    club_count = 0
    sorted_suits = sorted([suit1, suit2, suit3, suit4, suit5, suit6])
...
def flushes_kicker(suit1, suit2, suit3, suit4, suit5, suit6):
    flush_kicker = 0
    heart_count = 0
    diamond_count = 0
    spade_count = 0
...
def full_houses(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def full_house_kickers(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
    ...
    pair = 0
    trip = 0
    sorted_pip = sorted([new_pip1, new_pip2, new_pip3, new_pip4, new_pip5, new_pip6], reverse=True)
...
def quads(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def quads_kickers(pip1, pip2, pip3, pip4, pip5, pip6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
...
def straight_flushes(pip1, pip2, pip3, pip4, pip5, pip6, suit1, suit2, suit3, suit4, suit5, suit6):
    new_pip1 = face_cards(pip1)
    new_pip2 = face_cards(pip2)
    new_pip3 = face_cards(pip3)
    new_pip4 = face_cards(pip4)
    new_pip5 = face_cards(pip5)
    new_pip6 = face_cards(pip6)
    is_flush = flushes(suit1, suit2, suit3, suit4, suit5, suit6)
    is_flush_kicker = flushes_kicker(suit1, suit2, suit3, suit4, suit5, suit6)
    straight_flush = 0
    straight = 0
    unique_list = []
    list_of_pips2 = []
    list_of_suits = [suit1, suit2, suit3, suit4, suit5, suit6]
    list_of_pips = [new_pip1, new_pip2, new_pip3, new_pip4, new_pip5, new_pip6]
...
def best_hands6(pip1, pip2, pip3, pip4, pip5, pip6, suit1, suit2, suit3, suit4, suit5, suit6):
    ...
    hand_1_straight_flush = straight_flushes(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6,
                                             hand1_suit1, hand1_suit2, hand1_suit3, hand1_suit4,
                                             hand1_suit5, hand1_suit6)
    score = 0
    ordered_cards = []
    ...
    if hand_1_straight_flush == 0:
        hand_1_quads = quads(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6)
        if hand_1_quads > 0:
            ordered_cards.append(hand_1_quads)
            ordered_cards.append(hand_1_quads)
            ordered_cards.append(hand_1_quads)
            ordered_cards.append(hand_1_quads)
            if high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6) != hand_1_quads:
                ordered_cards.append(
                    high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6))
            elif second_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6) != hand_1_quads:
                ordered_cards.append(
                    second_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6))
            elif third_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6) != hand_1_quads:
                ordered_cards.append(
                    third_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6))
            elif fourth_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6) != hand_1_quads:
                ordered_cards.append(
            ...
            if hand_1_full_house == 0:
                ...
                if hand_1_flush > 0:
                    ...
                    list_of_suits = [hand1_suit1, hand1_suit2, hand1_suit3, hand1_suit4, hand1_suit5,
                                     hand1_suit6]
                    list_of_pips = [hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6]
                ...
                if hand_1_flush == 0:
                    ...
                    if hand_1_straight == 0:
                        ...
                        if hand_1_trips > 0:
                            ...
                            ordered_cards.append(hand_1_trips)
                            ordered_cards.append(hand_1_trips)
                            if high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6) != hand_1_trips:
                            ...
                            if second_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6)\
                                    < hand_1_trips_kicker and second_high_cards(hand1_pip1, hand1_pip2, hand1_pip3,
                                ...
                                ordered_cards.append(
                                    second_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5,
                                                  ...
                                                  hand1_pip6) < hand_1_trips_kicker and third_high_cards(hand1_pip1,
                                                                                                         hand1_pip2,
                                                                                                         hand1_pip3,
                                                                                                         hand1_pip4,
                                                                                                         hand1_pip5,
                                ...
                                ordered_cards.append(
                                    third_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5,
                                                   ...
                                                   hand1_pip6
                                                   ) < hand_1_trips_kicker and fourth_high_cards(hand1_pip1,
                                                                                                           hand1_pip2,
                                                                                                           hand1_pip3,
                                                                                                           hand1_pip4,
                                                                                                           hand1_pip5,
                        ...
                        if hand_1_trips == 0:
                            ...
                            if hand_1_two_pair > 0:
                                ...
                                if high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5,
                                              hand1_pip6) != hand_1_two_pair and high_cards(hand1_pip1,
                                                                                                        hand1_pip2,
                                                                                                        hand1_pip3,
                                                                                                        hand1_pip4,
                                                                                                        hand1_pip5,
                                                                                                        hand1_pip6,
                                                                                                        ) != hand_1_two_pair_kicker:
                                    ordered_cards.append(
                                        high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5,
                                                   hand1_pip6))
                                elif second_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5,
                                                       hand1_pip6) != hand_1_two_pair and second_high_cards(
                                    ...
                                    ordered_cards.append(
                                        second_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5,
                                                      ...
                                                      hand1_pip6) != hand_1_two_pair and third_high_cards(
                                    hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6
                                    ) != hand_1_two_pair_kicker:
                                    ordered_cards.append(
                                        third_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5,
                                                       ...
                                                       hand1_pip6) != hand_1_two_pair and fourth_high_cards(
                                    hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5, hand1_pip6
                                    ) != hand_1_two_pair_kicker:
                                    ordered_cards.append(
                                        fourth_high_cards(hand1_pip1, hand1_pip2, hand1_pip3, hand1_pip4, hand1_pip5,
