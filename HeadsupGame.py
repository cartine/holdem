...
# todo The code for settling up the pot, and increasing the players' chips, has to be taken out of the "decide" fcn.
# It hard to read and follow this way, and errors will creep in.
# We currently have duplication of code - you have to keep the money-keeping code correct in every single subclass
# of Player.

# todo have to move the classes out of the file with the program. Need to write multiple programs that access the classes.

# todo make Player.POS be an enum
# todo make Table.ROUND be an enum
