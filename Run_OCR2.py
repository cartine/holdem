...
filename = r'C:\Users\peter\OneDrive\Pictures\Screenshots\Screenshot (461).png'


def run_OCR2(filename):
    ...
    return decision, raise_amount, call_amount, self_chips


if __name__ == '__main__':
    print(run_OCR2(filename))
